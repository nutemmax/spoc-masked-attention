#!/bin/bash
#SBATCH --job-name=d25-50_lambda-scaling-teacher_ntrain
#SBATCH --output=logs/test-lambda-scaling-maskrandom-kappa0p4/lambda-scaling-d25-50_%A_%a.out
#SBATCH --error=logs/test-lambda-scaling-maskrandom-kappa0p4/lambda-scaling-d25-50_%A_%a.err
...
CONFIG_PATH=$1
# CONFIG_PATH="/home/anastass/spoc-masked-attention/configs/teacher_attention/tests-lambda-scaling-kappa0p4/d200"
...
SEED=42
SWEEP_DIR_REL="results/teacher-attention/iter_${ITERS}/lambda-scaling-test-kappa0p4/${CONFIG_NAME}/${CONFIG_NAME}_seed_${SEED}_${SWEEP_TIMESTAMP}"
